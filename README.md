...
```
make createvariables
```

###### sample output:

```json
$  make v="createStudy.json" createstudy
...
#### $ make createinvestigation v="<*file.json*>"
...
```json
$ make createinvestigation v="createInvestigation.json"
...
#### $ make customvariablesquerys v="<*file.json*>" q="<*file.txt*>"
...
###### sample output:
```json
$ make customvariablesquerys v="createStudy.json" q="createStudy.txt"
